...
constexpr Organism<species_t, sp1_eats_m, sp1_eats_p> mating(
                        ...
                        Organism<species_t, sp2_eats_m, sp2_eats_p> &organism2) {
    return Organism<species_t, sp1_eats_m, sp1_eats_p> (organism1.get_species(),
...
template <typename species_t>
constexpr std::tuple<Herbivore<species_t>, Herbivore<species_t>, std::optional<Herbivore<species_t>>>
...
encounter_series_helper(Organism<species_t, sp1_eats_m, sp1_eats_p> organism1, Organism<species_t, sp2_eats_m, sp2_eats_p> organism2, Args ... args) {
